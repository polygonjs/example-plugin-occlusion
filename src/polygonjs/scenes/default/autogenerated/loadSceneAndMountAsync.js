import {loadSceneData_default} from './loadSceneData.js?t=1643117594325';
...
export const loadSceneAndMountAsync_default = async function (options) {
	...
	const promises = [import('./loadSceneFromSceneData.js?t=1643117594325'), loadSceneData_default({onProgress}), ...modulePromises];
