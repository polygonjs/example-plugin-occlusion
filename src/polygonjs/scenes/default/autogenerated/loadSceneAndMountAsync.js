import {loadSceneData_default} from './loadSceneData.js?t=1648493294545';
...
export const loadSceneAndMountAsync_default = async function (options) {
	...
	const promises = [import('./loadSceneFromSceneData.js?t=1648493294545'), loadSceneData_default({onProgress, sceneDataRoot}), ...modulePromises];
